...
p1<-p+geom_line(size=0.8)+
  ...
  labs(title="The Big Mac index", x="Year",y="Under/Over Valued",color = "Country",subtitle="How much more expensive/cheaper is McDonald's in different countries than in the US?") +
